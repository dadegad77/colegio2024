<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-1 md:hidden">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href="{{ route('home') }}">INSTITUCION</a></li>
        <li><a href="{{ route('home') }}">MATRICULAS</a></li>
  ...
  <div class="flex-1 hidden md:flex space-x-4">
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">INSTITUCION</a>
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">MATRICULAS</a>
    <a href="{{ route('docentes.index') }}" class="btn btn-ghost btn-sm">DOCENTES</a>
