...
<html>
  <head>
    ...
    <title>LAESPERANZA</title>
    <div>
      <h1 class="text-3xl text-green-500 font-bold underline">

      <center>CENTRO PEDAGOJICO LA ESPERANZA</center>
      </h1>
        ...
        <div>
          <nav>
            <br><br><ul class="flex flex-row">
                ...
                <li><a href="#" class="d-sm-inline-flex-w-16 d-md-inline-flex-w-32 d-lg-inline-flex-w-48 mx-4 items-center justify-center px-12 py-4 text-base font-medium text-center text-black bg-gray-600 rounded-lg hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-900"> COMUNIDAD EDUCATIVA</a></li>
...
<br><br><main>
  <div>
    <h1 class="text-2xl text-green-500 font-bold underline">

    <center>IMAGEN</center>
    </h1>
    <img class="h-auto max-w-full" src="Users\Asus\Pictures\TEORIA GENERAL DE SISTEMAS\148700131_1676907192367.jpg" alt="image description">
...
<br><br><footer class="footer p-6 bg-neutral text-neutral-content  m-auto  ">
...
<aside>
  ...
  <p>Forjando los seres del mañana.<br>Dosquebradas,Risaralda</p>
</aside> 
<h1 class="text-3xl text-green-800 font-bold text-right text-balance">EDUCACION DE CALIDAD</h1>

<nav>
  <h6 class="footer-title">Encuentranos</h6> 
